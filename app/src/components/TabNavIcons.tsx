/** Simple 24×24 outline icons for bottom tab bar (Lucide-style). */

export function IconChats({ className }: { className?: string }) {
  return (
...
export function IconAIChat({ className }: { className?: string }) {
  return (
    <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
      <path d="M12 2a4 4 0 0 0-4 4v3H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8a2 2 0 0 0-2-2h-2V6a4 4 0 0 0-4-4z" />
      <path d="M9 14h6" />
      <path d="M9 18h6" />
    </svg>
  );
